 ...
 */
let nameInCaps = "Juanathan Bean"
let name = "juanathan bean"
if nameInCaps == name{
...
if nameInCaps.lowercased() == name{
    print(nameInCaps.lowercased() + " and " + name + " are the same."
}
else{
        print(nameInCaps.lowercased() + " and " + name + " are not the same.")
}
